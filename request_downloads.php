...
$subject = "最新のロジクラで資料ダウンロードされました/LP変更後";
...
$thanksPage = "https://logikura.jp/req_downloads.html";
...
$refrom_name = "クラウドかんたん在庫管理システム｜ロジクラ";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ロジクラへようこそ！2週間の無料トライアルをご案内します】";
...
このたびは、ロジクラへお問い合わせ頂き誠にありがとうございます。
ロジクラはクラウドで物流業務をかんたんに行うことができるサービスです。


これから数回にわたり、ロジクラをご理解いただくためのヒントと、お客様ならびにご担当の物流チームによる効率的な出荷活動、
また日々の在庫管理にロジクラをご活用いただく方法について、今回と同様のメールにてご案内させていただく予定です。
それでは担当者からご連絡を差し上げますので、今しばらくお待ち下さいませ。


ご質問や不明点がございましたら、いつでも『 info@newrevo.jp 』にお問い合わせください。担当者が対応させていただきます。
...
　■〒150-0022 東京都渋谷区恵比寿南 3-5-7 デジタルゲートビル Open Network Space 2階
　■〒810-0041 福岡県中央区大名 2-6-11FUKUOKA Growth Next (旧大名小学校)　
　 
　クラウドでかんたん在庫管理システム｜ロジクラ
　https://logikura.jp
...
<input type="submit" value="　送信する　" style="width: 150px;
    height: 60px;
    border-style: none;
    border-radius: 3px;
    color: #fff;
    font-size: 1.2rem; cursor:pointer; background:#ff9100;">
<input type="button" value="前画面に戻る" style="display:none;" onClick="history.back()"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
...
/* <![CDATA[ */
var google_conversion_id = 847759084;
var google_conversion_language = "en";
var google_conversion_format = "3";
var google_conversion_color = "ffffff";
var google_conversion_label = "fqpLCP6yoXUQ7I2flAM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/847759084/?label=fqpLCP6yoXUQ7I2flAM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="「".$subject."」で資料ダウンロードされました。\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
